...
class SegmentControls(QWidget):
    ...
    def add_segment(self, name: str, start: QTime, end: QTime) -> bool:
        ...
        fps_combo = QComboBox()
        fps_combo.addItem("1/sec", 1)
        fps_combo.addItem("2/sec", 2)
        fps_combo.addItem("5/sec", 5)
        fps_combo.addItem("10/sec", 10)
        fps_combo.addItem("20/sec", 20)
        fps_combo.addItem("50/sec", 50)
