"""
3D Reconstruction Viewer window.

Moved from GUI/reconstruction_window.py. Uses shared theme, geometry,
and constants. Adds DebouncedGeometryMixin for efficient geometry saves.
"""
...
class ReconstructionWindow(QMainWindow, DebouncedGeometryMixin):
